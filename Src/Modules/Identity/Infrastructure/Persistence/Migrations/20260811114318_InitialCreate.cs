        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AccountManagerUserId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    CustomerId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    AssignedAtUtc = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_AccountManagerAssignments", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ImpersonatorUserId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    TargetCustomerUserId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SubAccountPermissions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SubAccountPermissions_SubAccounts_SubAccountId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SubAccountScopes", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SubAccountScopes_SubAccounts_SubAccountId",
                        column: x => x.SubAccountId,
                        principalTable: "SubAccounts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ImpersonationAuditLogs_ImpersonatorUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SubAccountPermissions_SubAccountId",
                table: "SubAccountPermissions",
                column: "SubAccountId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SubAccountScopes_SubAccountId",
                table: "SubAccountScopes",
                column: "SubAccountId");
